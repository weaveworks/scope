...
1. Transition from a primarily Weaveworks project to a true community-driven project with autonomous governance. Weaveworks noticed interest from various actors, and decided to to nurture the community and see where it can lead the project.
