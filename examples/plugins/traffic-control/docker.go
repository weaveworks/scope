...
// DockerClient communicates with the docker daemon.
type DockerClient struct {
	store  *Store
	client *docker.Client
}

// NewDockerClient creates a client that will put container
// information into a given store.
...
// Start tells the docker client to start talking to the docker
// daemon. Should be run in a separate goroutine.
