...
// Plugin holds all the data the traffic control needs for its work.
type Plugin struct {
	reporter *Reporter
...
// NewPlugin creates a new plugin with a reporter and container clients.
...
// Serve tells the plugin to listen on the interface-specific
// endpoints.
