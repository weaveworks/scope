...
func (c *container) GetNode() report.Node {
	...
	if c.container.State.Paused {
		...
		controls = append(controls, RestartContainer, StopContainer, PauseContainer, AttachContainer, ExecContainer, SpeedSlowContainer, SpeedMediumContainer, SpeedFastContainer)
	} else {
