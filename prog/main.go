...
func setupFlags(flags *flags) {
	...
	flag.DurationVar(&flags.probe.kubernetesClientConfig.Interval, "probe.kubernetes.interval", 0, "how often to do a full resync of the kubernetes data (zero=never)")
