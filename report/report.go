...
func MakeReport() Report {
	return Report{
		Endpoint:       MakeTopology(Endpoint),
		Address:        MakeTopology(Address),
		Process:        MakeTopology(Process),
		Container:      MakeTopology(Container),
		ContainerImage: MakeTopology(ContainerImage),
		Host:           MakeTopology(Host),
		Pod:            MakeTopology(Pod),
		Service:        MakeTopology(Service),
		Overlay:        MakeTopology(Overlay),
		Sampling:       Sampling{},
		Window:         0,
